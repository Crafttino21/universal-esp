...
if not syn and not PROTOSMASHER_LOADED then print'You Need synapse X for this!' end
...
local LastRefresh = 0
local OptionsFile = 'PRX_ESP_SETTINGS.dat'
local Binding = false
local BindedKey = nil
local OIndex = 0
local LineBox = {}
...
shared.RSName = shared.RSName or ('ProjectX_by_WeepingAngel' .. HttpService:GenerateGUID(false))
