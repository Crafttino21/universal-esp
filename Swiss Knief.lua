...
MainSection:NewButton("Toggle Silent Aimbot", "More settings, more silence :)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Crafttino21/universal-esp/main/silentaim"))()
end)
